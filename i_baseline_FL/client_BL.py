...
class Client:
    ...
    def update(self, global_weights):
        ...
        # NOTE: In the future, when implementing homomorphic encryption, you would encrypt
        # the updated model weights here before returning/sending them. The encryption step
        # would add additional load, which would be reflected in these statistics.
...
with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
    ...
    while True:
        ...
        # Train and send update (CPU, Memory, and Available Memory sampling is done in update())
        updated_weights = client.update(global_weights)
        
        # Here, if you add homomorphic encryption, you would encrypt updated_weights before sending.
