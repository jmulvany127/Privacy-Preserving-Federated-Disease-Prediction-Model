...
def load_raw_data():
    ...
    return covid_images[:500], non_covid_images[:500]
...
def measure_memory():
    ...
    # Save the trained model after federated training
    current_directory = os.getcwd()
    model_save_path = os.path.join(current_directory, "local_trained_model")
