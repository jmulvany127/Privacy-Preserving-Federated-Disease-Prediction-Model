...
#nohup python3 -u server_LDP.py --num_clients $NUM_CLIENTS --use_he False > server.log 2>&1 &
...
for ((i=0; i<$NUM_CLIENTS; i++)); do
    ...
    #nohup python3 client_LDP.py --client_id $i --num_clients $NUM_CLIENTS --use_dp False --use_he False > client$i.log 2>&1 &
